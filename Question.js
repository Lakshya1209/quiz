class Question {
    ...
    display(){
    this.title.html("Youtubers Question");
    this.title.position(350,0);

    this.question.html("Which of these creators make funny non veg skit ?");
    this.question.position(100,30);
    this.option1.html("1: Live Insaan/Triggered Insaan");
    this.option1.position(150,60);
    this.option2.html("2: Carryminati");
    this.option2.position(150,100);
    this.option3.html("3: Ashish Chanchlani");
    this.option3.position(150,140);
    this.option4.html("4: Mythpat");
    ...
    this.button.mousePressed(()=>{
      ...
      if(person.answer==="Ashish Chanchlani"){
        //fill("green");
